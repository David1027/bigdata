(function () {
    var bigData = {
        ...
        init: function () {
            var _that = this
            if (sessionStorage && !sessionStorage[_that.config.key + _that.config.project]) {
                sessionStorage[_that.config.key + _that.config.project] = document.referrer;
            }
            ...
            window.addEventListener('unload', function (event) {
                _that.data.firstReferrer = sessionStorage[_that.config.key + _that.config.project]
